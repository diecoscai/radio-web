    ...
    f.platform && ((a.jPlayer.platform[f.platform] = !0), (a.jPlayer.platform.mobile = !f.tablet), (a.jPlayer.platform.tablet = !!f.tablet)),
      ...
      (a.jPlayer.nativeFeatures = {
        init: function () {
          ...
          for (
            this.fullscreen = a = { support: { w3c: !!d[f.w3c[0]], moz: !!d[f.moz[0]], webkit: "function" == typeof d[f.webkit[3]], webkitVideo: "function" == typeof e[f.webkitVideo[2]], ms: "function" == typeof e[f.ms[2]] }, used: {} },
              b = 0,
              c = g.length;
            c > b;
            b++
        ...
        _addAuroraEventListeners: function (b, c) {
          ...
          (b.volume = 100 * this.options.volume),
            b.on(
              ...
              function () {
                c.gate &&
                  (d.internal.cmdsIgnored && this.readyState > 0 && (d.internal.cmdsIgnored = !1), d._getAuroraStatus(b), d._updateInterface(), d._trigger(a.jPlayer.event.progress), b.duration > 0 && d._trigger(a.jPlayer.event.timeupdate));
              },
              !1
            ),
            b.on(
        ...
        _updateInterface: function () {
          ...
          this.css.jq.duration.length &&
            ("string" == typeof this.status.media.duration
              ...
              : ("number" == typeof this.status.media.duration && ((c = this.status.media.duration), (d = c - this.status.currentTime)), (b = this.options.remainingDuration ? (d > 0 ? "-" : "") + this._convertTime(d) : this._convertTime(c))),
            ...
            d
              ? ((this.status.nativeVideoControls && this.html.video.gate) || (this._validString(b.poster) && (e ? (this.htmlElement.poster.src = b.poster) : this.internal.poster.jq.show())),
                "string" == typeof b.title &&
                  (this.css.jq.title.length && this.css.jq.title.html(b.title), this.htmlElement.audio && this.htmlElement.audio.setAttribute("title", b.title), this.htmlElement.video && this.htmlElement.video.setAttribute("title", b.title)),
